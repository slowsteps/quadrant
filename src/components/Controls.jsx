...
export default function Controls() {
    ...
    const handleAiSuggestion = async () => {
        try {
            ...
            // Add product with axis values, logo URL, reasoning, USPs, specifications, and sources from AI suggestion
            addProduct(suggestion.name, axisValues, suggestion.logoUrl || null, suggestion.reasoning || null, suggestion.usps || null, suggestion.domain || null, suggestion.specifications || {}, suggestion.sources || []);
        } catch (err) {
